...
import { Home, Calendar, FileText, Award, HelpCircle, Settings, Pencil, Power } from "lucide-react";

const Sidebar = ({ isOpen, toggleSidebar }) => {
    const navItems = [
        { icon: Home, label: "Dashboard", path: "/teacherDashboard" },
        { icon: Pencil, label: "Exams", path: "/teacherDashboard/exams" },
        { icon: Pencil, label: "Add Exam", path: "/teacherDashboard/add-exam" },
        { icon: Calendar, label: "Students", path: "/teacherDashboard/students" },
        { icon: FileText, label: "Assignments", path: "/teacherDashboard/assignments" },
        { icon: Award, label: "Grades", path: "/teacherDashboard/grades" },
        { icon: HelpCircle, label: "Help Center", path: "/teacherDashboard/help" },
        { icon: Settings, label: "Settings", path: "/teacherDashboard/settings" },
    ];
