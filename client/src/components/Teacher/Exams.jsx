...
import { CalendarIcon, ClockIcon, MapPinIcon, EditIcon } from "lucide-react";
    ...
    return (
        <div className="min-h-screen bg-gray-50">
            <div className="bg-gradient-to-r from-blue-500 to-purple-600 text-white shadow-lg py-4 px-4 sm:px-6 lg:px-8">
                ...
                <p className="mt-2 text-lg">Edit exams and add questions</p>
            </div>
                                ...
                                {filteredExams.map((exam) => (
                                    <tr key={exam._id} className="transition duration-300 ease-in-out hover:bg-gray-50">
                                        ...
                                        <td className="px-6 py-4 whitespace-nowrap text-sm font-medium">
                                            <Link to={`/teacherDashboard/exams/${exam._id}`}>
                                                <button
                                                    className="py-2 px-4 rounded-md bg-indigo-600 text-white hover:bg-indigo-700 transition duration-150 ease-in-out focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500"
                                                >
