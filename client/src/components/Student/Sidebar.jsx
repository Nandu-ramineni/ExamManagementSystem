...
const Sidebar = ({ isOpen, toggleSidebar }) => {
    const navItems = [
        ...
        { icon: Pencil, label: "Exams", path: "/studentDashboard/exams" },
        { icon: Calendar, label: "Schedule", path: "/studentDashboard/schedule" },
        { icon: FileText, label: "Assignments", path: "/studentDashboard/assignments" },
        { icon: Award, label: "Grades", path: "/studentDashboard/grades" },
        { icon: HelpCircle, label: "Help Center", path: "/studentDashboard/help" },
