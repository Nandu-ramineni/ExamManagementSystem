...
const AddStaff = () => {
    ...
    const validateForm = () => {
        ...
        if (!data.staffId.trim()) newErrors.staffId = "Staff ID is required"
        setErrors(newErrors)
    ...
    return (
        <div className="max-w-md mx-auto mt-10 p-6 bg-white border rounded-lg shadow-lg">
            <h2 className="text-2xl font-bold mb-6 text-center text-gray-800">Add New Staff Member</h2>
            {success && (
            ...
            <form onSubmit={submitHandler} noValidate>
                ...
                <div className="mb-6">
                    <label htmlFor="staffId" className="block mb-2 text-sm font-medium text-gray-700">
                        Staff ID
                    </label>
                    <div className="relative">
                        <div className="absolute inset-y-0 left-0 pl-3 flex items-center pointer-events-none">
                        ...
                        <input
                            ...
                            value={data.staffId}
                            onChange={changeHandler}
                            className={`pl-10 py-2 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 ${errors.staffId ? 'border-red-500' : ''
                                }`}
                            required
                        />
                    </div>
